...
async def main():
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
        ...
        # Let's first make my tcp more concrete before I add more channels
        # pipelineGraphChannel = {
        #     "topic": "pipelineGraph",
        #     "encoding": "json",
        #     "id": 2,
        #     "schemaName": "luxonis.DepthaiPipelineGraph",
        #     "schema": json.dumps({
        #         "type": "object",
        #         "properties": {
        #             "pipeline": {
            ...
            while i < limit:
                ...
                if not args.disable_color:
                    ...
                    if qRgb.has():
                        ...
                        # exit(0)
                        # open("yuv.bin", "w").write(",".join(str(int(x)) for x in im.DataAsNumpy().tobytes()))
